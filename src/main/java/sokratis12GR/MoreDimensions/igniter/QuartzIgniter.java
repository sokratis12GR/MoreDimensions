...
public class QuartzIgniter{

public QuartzIgniter(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(QuartzDimension.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(Blocks.quartz_block, 1), new ItemStack(Items.flint, 1), 
});}
