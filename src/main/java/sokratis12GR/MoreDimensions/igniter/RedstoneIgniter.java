...
public class RedstoneIgniter{

public RedstoneIgniter(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(RedstoneDimension.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(Blocks.redstone_block, 1), new ItemStack(Items.flint, 1), 
});}
