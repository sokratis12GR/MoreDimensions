...
public class EmeraldIgniter{

public EmeraldIgniter(){}

public Object instance;public void load(FMLInitializationEvent event){
ItemStack recStack = new ItemStack(EmeraldDimension.block, 1);


GameRegistry.addShapelessRecipe(recStack, new Object[]{
new ItemStack(Blocks.emerald_block, 1), new ItemStack(Items.flint, 1), 
});}
