...
public class QuartzWorld {

public static BiomeGenquartzWorld biome = new BiomeGenquartzWorld();
...
static class BiomeGenquartzWorld extends BiomeGenBase
{
	public BiomeGenquartzWorld()
    {
        super(50);
        setBiomeName("Quartz World");
        topBlock = Blocks.quartz_block.getDefaultState();
        fillerBlock = Blocks.quartz_ore.getDefaultState();
