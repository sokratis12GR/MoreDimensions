...
public class EmeraldWorld {

public static BiomeGenemeraldWorld biome = new BiomeGenemeraldWorld();
...
static class BiomeGenemeraldWorld extends BiomeGenBase
{
	public BiomeGenemeraldWorld()
    {
        super(45);
        setBiomeName("Emerald World");
