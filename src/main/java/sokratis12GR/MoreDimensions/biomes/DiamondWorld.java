...
public static BiomeGendiamondWorld biome = new BiomeGendiamondWorld();
...
static class BiomeGendiamondWorld extends BiomeGenBase
{
	public BiomeGendiamondWorld()
    {
        super(46);
        setBiomeName("Diamond World");
