...
public class GoldWorld {

public static BiomeGengoldWorld biome = new BiomeGengoldWorld();
...
static class BiomeGengoldWorld extends BiomeGenBase
{
	public BiomeGengoldWorld()
    {
        super(44);
        setBiomeName("Gold World");
        topBlock = Blocks.gold_block.getDefaultState();
