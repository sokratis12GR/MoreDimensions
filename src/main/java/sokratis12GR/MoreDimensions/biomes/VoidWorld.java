...
public static BiomeGenvoidWorld biome = new BiomeGenvoidWorld();
...
static class BiomeGenvoidWorld extends BiomeGenBase
{
	public BiomeGenvoidWorld()
    {
        super(48);
        setBiomeName("Void World");
